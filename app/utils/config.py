...
VERSION: str = config_project('VERSION', default='0.0.2')
...
GEO_LITE_TAR_FILE_URL = f'https://download.maxmind.com/app/geoip_download' f'?edition_id=GeoLite2-City' f'&license_key={GEO_LICENSE_KEY}' f'&suffix=tar.gz'
# TODO: add legacy
